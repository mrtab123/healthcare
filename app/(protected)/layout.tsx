...
const ProtectedLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="w-full h-screen flex " >
      ...
      <div className="fixed top-0 left-0 h-full w-[14%] md:w-[8%] lg:w-[16%] xl:w-[14%] bg-white shadow-md z-10">
      ...
      <div className=" ml-[10%] md:ml-[8%] lg:ml-[16%] xl:ml-[14%] w-[90%] md:w-[92%] lg:w-[84%] xl:w-[86%] flex flex-col">
        ...
        <div className="h-full w-full p-2  remove-scrollbar bg-gray-50 ">{children}</div>
      </div>
    </div>
  );
};
